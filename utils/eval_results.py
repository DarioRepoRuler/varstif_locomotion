...
print(f"Success shape: {push_data['success'].shape} and kick_theta shape: {push_data['kick_theta'].shape} and kick_force_magnitude shape: {push_data['kick_force_magnitude'].shape}")
polar_scatter_push_plot(push_data['kick_force_magnitude'], push_data['kick_theta'], push_data['success'], 'Force Push randoall1')
