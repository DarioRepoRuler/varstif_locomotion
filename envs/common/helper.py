...
from mujoco.mjx import JointType, Model, TrnType
...
def jac(
        m: mjx.Model, d: mjx.Data, point: jax.Array, body_id: jax.Array
    ...
    mask = body_tree(m, fn, 'b', 'b', mask, reverse=True)
...
def unscale(x: jax.Array, lower: jax.Array, upper: jax.Array) -> jax.Array:
